  ...
  <div class="support-shell">
    ...
    <div class="support-lower-grid section">
      <section class="panel support-faq-card">
        <div class="panel-head"><div><h2>Frequently Asked Questions</h2><p>Common questions about your DOT C/TPA workspace.</p></div></div>
...
function bind(d={},ctx={}){
  ...
  form?.addEventListener('submit',async e=>{
    ...
    try{
      const r=await window.Portal.invoke('workforce-support',{action:'create',...v,page_title:v.page_title||document.title,portal_page:storedContext().page_id||null});
